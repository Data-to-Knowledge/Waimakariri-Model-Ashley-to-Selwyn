...
from waimak_extended_boundry.model_run_tools.stream_depletion_support.stream_depletion_model_setup import \
    setup_and_run_stream_dep
...
def get_str_dep_base_path(model_id, sd_version, ss_sy_version=1, recalc=False):
    ...
    run this run has a ss and then full year run from july to end of june
