...
from waimak_extended_boundry.model_run_tools import mod_gns_model, get_base_well, create_mp_slf, \
    export_paths_to_shapefile, get_zone_array_index
...
if __name__ == '__main__':
    set_up_run_no_pumping_chch_selwyn('NsmcBase', "C:\Users\MattH\Desktop\simple_modpath_no_south_pumping",
                                      'simple_modpath_no_south_pumping')
