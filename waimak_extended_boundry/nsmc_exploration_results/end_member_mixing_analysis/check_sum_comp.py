...
alpine = flopy.utils.UcnFile(
    env.gw_met_data(r"mh_modeling\data_from_gns\mt_aw_ex_alpine_philow\mt_aw_ex_alpine_philow.ucn")).get_data(kstpkper=(0, 0))
...
coastal = flopy.utils.UcnFile(
    env.gw_met_data(r"mh_modeling\data_from_gns\EM_coast_ucnrepo\mt_aw_ex_coastal_philow.ucn")).get_data(kstpkper=(0, 0))
