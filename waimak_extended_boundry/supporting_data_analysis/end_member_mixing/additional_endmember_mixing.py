...
"""
Author: matth
Date Created: 5/04/2018 9:34 AM
"""
...
if __name__ == '__main__':
    ...
    targets = pd.read_csv(
        r"\\gisdata\projects\SCI\Groundwater\Waimakariri\Groundwater\Groundwater Quality\End member mixing model\targets_for_well_adjust\cl_o18_data_grouped.csv",
        index_col=0)
    sites = {}
    ...
    mc_calc_end_members(
        r"\\gisdata\projects\SCI\Groundwater\Waimakariri\Groundwater\Groundwater Quality\End member mixing model\targets_for_well_adjust\4_members",
        sites, end_mean_o18, end_sd_o18, end_mean_cl, end_sd_cl,n=1000)
    print'done'
